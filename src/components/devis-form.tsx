  ...
  return (
    <div className="w-full mt-12">
      <div className="bg-[#FF6F3C] rounded-3xl p-8 md:p-12 flex flex-col w-full">
        ...
        <form className="w-full grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4" onSubmit={e => e.preventDefault()}>
          {/* Left column */}
          <div className="flex flex-col gap-4">
            ...
            <div className="relative">
              ...
              <input className="pl-10 pr-4 py-3 rounded-2xl w-full bg-white text-gray-900 placeholder-gray-400 outline-none text-lg" placeholder={t.name} required />
            </div>
            <label className="text-white text-base mb-1 text-left">{t.firstname}</label>
            <div className="relative">
              <FaUser className="absolute left-3 top-1/2 -translate-y-1/2 text-black text-lg" />
              <input className="pl-10 pr-4 py-3 rounded-2xl w-full bg-white text-gray-900 placeholder-gray-400 outline-none text-lg" placeholder={t.firstname} required />
            </div>
            ...
            <div className="relative">
              ...
              <input className="pl-10 pr-4 py-3 rounded-2xl w-full bg-white text-gray-900 placeholder-gray-400 outline-none text-lg" placeholder={t.email} type="email" required />
            </div>
          </div>
          {/* Right column */}
          <div className="flex flex-col gap-4 justify-end h-full">
            ...
            <div className="relative">
              ...
              <input className="pl-10 pr-4 py-3 rounded-2xl w-full bg-white text-gray-900 placeholder-gray-400 outline-none text-lg" placeholder={t.phone} required />
            </div>
            ...
            <div className="relative">
              ...
              <input className="pl-10 pr-4 py-3 rounded-2xl w-full bg-white text-gray-900 placeholder-gray-400 outline-none text-lg" placeholder={t.address} required />
            </div>
            <div className="flex-1" />
            <button type="submit" className="mt-6 w-full flex items-center justify-center gap-2 bg-white text-[#FF6F3C] text-xl font-semibold rounded-2xl py-3 transition-all duration-300 hover:bg-[#FF6F3C]/90 hover:text-white">
              {t.send}
