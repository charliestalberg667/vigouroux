...
const content: Record<string, PowerCTAContent> = {
  nl: {
    ...
    exploreShowroom: "bezoek de showroom",
    inverterText: "omvormers vanaf 200 kW",
    batteryText: "batterijen vanaf 250 kWh",
    moreCapacityText:
      "Als u minder vermogen nodig heeft, schakelt u over naar de bedrijfs modus.",
    exampleButton: "voorbeeld installatie",
    businessButton: "bedrijf",
    transformText: {
  ...
  fr: {
    ...
    exploreShowroom: "visiter le showroom",
...
export function PowerCTAIndustrialMobile() {
  const { language } = useLanguage();
  const t = content[language];

  return (
    <div className="flex max-h-196 items-center justify-center mt-8 mb-8">
      <div className="grid grid-rows-2 gap-8 max-w-4xl text-center">
